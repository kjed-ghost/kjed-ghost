        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16 lg:gap-32">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-500 max-w-sm text-lg font-medium leading-relaxed">
              Engineering digital excellence through full-stack precision and AI-driven innovation. Based in India, serving global pioneers.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              {['Home', 'Services', 'Projects', 'About', 'Contact'].map((item) => (
                <li key={item}>
                  <Link href={item === 'Home' ? '/' : `/${item.toLowerCase()}`} className="text-gray-500 hover:text-neon-cyan transition-colors text-lg font-bold flex items-center gap-2 group">
                    {item}
          ...
          <div>
            <h3 className="text-[10px] font-black text-white uppercase tracking-[0.3em] mb-8">Connect</h3>
